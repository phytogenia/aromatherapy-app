...
class recipesdetails extends StatefulWidget {
  const recipesdetails({Key? key}) : super(key: key);

  @override
  _oildetailsState createState() => _oildetailsState();
}

class _oildetailsState extends State<recipesdetails> {
  bool isObscure = true;
  int SelectedIndex = 0;
  List aspect = [];
  List colo = [];
  ...
  getData() {
    setState(() {
      ...
      odor.addAll(['Arbre a the', 'Arbre', 'Arbre a the','Arbre a the']);
    });
  }
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            colorFilter: ColorFilter.mode(
                                const Color(0xFFE88B00).withOpacity(.8),
                                BlendMode.srcOver),
